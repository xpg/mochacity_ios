//
//  AMIPhoneSettingPersonalController.m
//  AppMocha
//
...
@interface AMIPhoneSettingPersonalController(Private)

- (void)sendSaveData;

@end

@implementation AMIPhoneSettingPersonalController
    ...
    switch (indexPath.section) {
        case 0: {
            [UIView animateWithDuration:.2 animations:^{
                ...
                [_textFieldJob setEnabled:NO];
                [personalSettingTableView setContentSize:CGSizeMake(320, 360)];
                [personalSettingTableView scrollRectToVisible:CGRectMake(0, 0, personalSettingTableView.frame.size.width, personalSettingTableView.frame.size.height) animated:YES];
        ...
        case 1: {
            if (_agePickerView.frame.origin.y > self.view.frame.size.height) {
                [UIView animateWithDuration:.2 animations:^{
                    [_agePickerView setFrame:CGRectMake(self.view.frame.size.width/2-100, self.view.frame.size.height - 250, 200, 200)];
        ...
        case 2:
            if (_earnPickerView.frame.origin.y > self.view.frame.size.height) {
                [UIView animateWithDuration:.2 animations:^{
                    [_earnPickerView setFrame:CGRectMake(self.view.frame.size.width/2-100, self.view.frame.size.height - 250, 200, 200)];
        ...
        case 3:
            ...
            [personalSettingTableView setContentSize:CGSizeMake(320, 600)];
            [personalSettingTableView scrollRectToVisible:CGRectMake(0, 200, personalSettingTableView.frame.size.width, personalSettingTableView.frame.size.height) animated:YES];
            break;
        default:
            break;
    }
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    @synchronized ([AMIPhoneSettingPersonalController class]) {
        if ([pickerView isEqual:_agePickerView]) {
