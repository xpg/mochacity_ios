...
@implementation AMIPhoneRegistrationView
...
- (void)setBecomeFirstResponser {
    [registerView setFrame:CGRectMake(19, 0, 282, 200)];
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField {
    [registerView setClipsToBounds:YES];
    [registerView setScrollEnabled:YES];
    if (textField == passwordField) {
        [registerView scrollsToTop];
    } else if (textField == checkField){
        [registerView setContentOffset:CGPointMake(0, 30)];
        
    } else if (textField == codeField) {
        [registerView setContentOffset:CGPointMake(0, 50)];
    } else {
        [registerView scrollsToTop];
    }
    
    [registerView setContentSize:CGSizeMake(282, 251)];
    return YES;
}
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    if (textField == emailField) {
        ...
        [registerView setScrollEnabled:NO];
        [registerView setFrame:CGRectMake(19, 73, 282, 251)];
    }
